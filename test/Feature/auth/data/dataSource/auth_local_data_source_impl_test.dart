...
void main() {
  ...
  group('AuthLocalDataSourceImpl Tests', () {
    group('writeToken', () {
      test('should write token successfully and return ApiSuccessResult', () async {
        // Arrange
        ...
        verify(mockStorage.write(key: AppConstants.token, value: token)).called(1);
      });
    ...
    group('setRememberMe', () {
      test('should set remember me to true and return ApiSuccessResult', () async {
        // Arrange
        ...
        // Act
        final result = await authLocalDataSource.setRememberMe(rememberMe: rememberMe);

        // Assert
        expect(result, isA<ApiSuccessResult<void>>());
        verify(mockStorage.write(key: AppConstants.rememberMe, value: 'true')).called(1);
      });

      test('should set remember me to false and return ApiSuccessResult', () async {
        // Arrange
        ...
        // Assert
        expect(result, isA<ApiSuccessResult<void>>());
        verify(mockStorage.write(key: AppConstants.rememberMe, value: 'false')).called(1);
      });
    ...
    group('getRememberMe', () {
      ...
      test('should return true when stored value is "TRUE" (case insensitive)', () async {
        // Arrange
        when(mockStorage.read(key: AppConstants.rememberMe))
            .thenAnswer((_) async => 'TRUE');
