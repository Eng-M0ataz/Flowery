...
// in flower_e_commerce_app/test/Feature/auth/data/dataSource/auth_remote_data_source_impl_test.dart.
...
class MockApiServices extends _i1.Mock implements _i3.ApiServices {
  ...
  _i4.Future<_i2.SigninResponseDto> signIn(
          {required _i5.SigninRequestDto? request}) =>
      (super.noSuchMethod(
        Invocation.method(
          #signIn,
          [],
        ...
        returnValue:
            _i4.Future<_i2.SigninResponseDto>.value(_FakeSigninResponseDto_0(
          this,
          Invocation.method(
            #signIn,
            [],
