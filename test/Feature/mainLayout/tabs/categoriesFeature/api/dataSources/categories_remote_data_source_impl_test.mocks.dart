...
// in flower_e_commerce_app/test/Feature/mainLayout/tabs/categoriesFeature/api/dataSources/categories_remote_data_source_impl_test.dart.
...
class _FakeCategoryResponseDto_0 extends _i1.SmartFake
    implements _i2.CategoryResponseDto {
...
class MockApiServices extends _i1.Mock implements _i4.ApiServices {
  ...
  @override
  _i5.Future<_i3.ProductResponseDto> getCategoryProductsCategory(
          _i6.GetProductsByCategoryRequestModel? requestModel) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCategoryProductsCategory,
          [requestModel],
        ),
        returnValue:
