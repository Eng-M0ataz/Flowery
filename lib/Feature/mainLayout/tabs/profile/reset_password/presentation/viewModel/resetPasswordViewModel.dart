...
import 'package:flower_e_commerce_app/Feature/mainLayout/tabs/profile/reset_password/domain/useCases/ResetPasswordUseCase.dart';
  ...
  Future<void> _resetPassword() async {
    ...
    switch (result) {
      case ApiSuccessResult<ResetPasswordResponseEntity>():
        emit(state.copyWith(
            isLoading: false, failure: null, resetPasswordSuccess: true));
        break;
