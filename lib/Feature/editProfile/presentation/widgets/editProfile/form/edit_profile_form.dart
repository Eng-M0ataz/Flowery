...
import 'package:flower_e_commerce_app/Feature/editProfile/presentation/widgets/product_shimmer.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileViewModel, ProfileState>(
      ...
      return Scaffold(
          ...
          body: SafeArea(
            child:state.isLoading?ProfileShimmer():
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomElevatedButton(
                            onPressed:  (state.isDataChanged && !state.isUpdating)
                                ? () {
