...
import 'package:flower_e_commerce_app/Feature/auth/presentation/widgets/signIn/custom_check_box.dart';
...
class _SigninScreenState extends State<SigninScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: CustomBackButton(title: LocaleKeys.login.tr()),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Row(
                          children: [
                            CustomCheckBox(viewModel: _viewModel),
                    ...
                    OutlinedButton(
                      ...
                      style: OutlinedButton.styleFrom(
                        minimumSize:
                            Size(double.infinity, AppSizes.buttomHigh_48),
                      ),
